...
class User extends ActiveRecord\Model
{
    ...
    static $validates_size_of = array(
        ...
        array('codigopostal', 'is' => 8, 'message' => 'O campo do código postal deve conter o seguinte formato 0000-000!'),
    ...
    static $validates_format_of = array(
        array('email', 'with' => '/^[^0-9][A-z0-9_]+([.][A-z0-9_]+)*[@][A-z0-9_]+([.][A-z0-9_]+)*[.][A-z]{2,4}$/', 'message' => 'O email inserido é inválido!')
    );
